...
RUN case $TARGETARCH in \
    ...
    wget -O wkhtmltox_0.12.6.1-3.deb https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6.1-3/wkhtmltox_0.12.6.1-3.bookworm_${arch}.deb
WORKDIR /odoo
RUN git clone https://github.com/odoo/odoo --depth 1 --branch ${ODOO_VERSION} --single-branch odoo-${ODOO_VERSION}
